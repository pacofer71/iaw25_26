<?php
    session_start();
    $usuarios=[
        'admin@email.es'=>['secret0', 1], //perfil 1=admin
        'user@email.es'=>['secret1', 2],  //perfil 2 =user normal
        'manolo@email.es'=>['secret2', 2]
    ];
    if(isset($_POST['email'])){
        ...
        $_SESSION['error']="*** User o password Incorrectos!!!";
